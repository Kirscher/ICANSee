...
def evaluate_gastronet_baseline(data_path, output_dir=None, batch_size=128, input_size=224):
    """
    ...
    if not os.path.exists(gastronet_path):
        raise FileNotFoundError(f"Gastronet weights not found at {gastronet_path}")
    ...
    if summary is not None:
        ...
        bootstrap_file = output_dir / "gastronet_baseline_bootstrap_summary.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Gastronet baseline model performance")
